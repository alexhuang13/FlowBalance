#!/usr/bin/env python3
"""Post-checkpoint benchmark validation for one FlowOPSD experiment.
...
def parse_args():
    ...
    p.add_argument('--algorithm', default='flowopsd')
    p.add_argument('--model-tag-prefix', default='flowopsd')
