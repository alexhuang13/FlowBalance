...
FLOW_ACTOR=${ROOT}/output/verl-flowopsd/FlowOPSD-Qwen3-8B-math-dapo17k-betaq1-grpo-signadv-frozenref-etaR15-lr1e6-run28/global_step_410/actor
...
merge_one flowopsd_step410 "$FLOW_ACTOR"
cd "$WORK"
...
for spec in grpo_final rlsd_step190 flowopsd_step410; do
