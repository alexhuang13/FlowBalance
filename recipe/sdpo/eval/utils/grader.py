...
def math_equal(
    ...
    if "," in prediction and "," in reference:
        ...
        if len(pred_parts) == len(ref_parts):
            # sort both lists then compare element-by-element, using math_equal to recursively check equality
    ...
    #     if len(pred_parts) == len(ref_parts):
    #         # sort each element of both lists then compare one-by-one, using math_equal to recursively check equality
