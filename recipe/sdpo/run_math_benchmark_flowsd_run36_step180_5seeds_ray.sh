...
RUN_DIR=${ROOT}/output/verl-flowsd/FlowSD-Qwen3-8B-math-dapo17k-betaq1-grpo-signadv-frozenref-etaR5-lr1e6-step180-run28fixed-run36
ray job submit \
  ...
  python3 ${ROOT}/FlowSD/evaluation/math/scripts/ray_flowsd_step180_val.py \
    --run-dir "${RUN_DIR}" \
    --experiment-name auden_flowsd_etaR5_10_30_step180_run28fixed_run36 \
    --step 180 \
    --seeds 0 1 2 3 4 \
    --temperature 0.6 \
    --top-p 0.95 \
