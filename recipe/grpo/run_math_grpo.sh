#!/usr/bin/env bash
# GRPO baseline run script (loss_mode=vanilla -> standard GRPO, no self-distillation).
#
...
exp_name=${EXP_NAME:-'GRPO-DeepSeek-R1-Distill-Qwen-7B-math'}
...
max_model_len=10240                 # rollout / ppo_max_token_len_per_gpu
...
desired_train_prompt_bsz=${TRAIN_PROMPT_BSZ:-32}
