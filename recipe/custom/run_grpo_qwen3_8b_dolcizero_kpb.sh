...
project_name='kpb-grpo-baseline'
exp_name='GRPO-Qwen3-8B-Base-DOLCIZERO-robustdapoRM'
...
MODEL_PATH=${MODEL_PATH:-"/apdcephfs_gy4/share_303378103/user/audenhuang/models/Qwen3-8B"}
...
ray job submit --address="${RAY_ADDRESS}" --no-wait --runtime-env="${RUNTIME_ENV}" \
    -- python3 -m core.trainer.main_ppo \
    ...
    custom_reward_function.path="${WORKING_DIR}/core/utils/reward_score/robust_dapo_score.py" \
