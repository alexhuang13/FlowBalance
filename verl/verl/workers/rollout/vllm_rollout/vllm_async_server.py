...
# vLLM V1/Triton may compile small CUDA helper extensions inside Ray actors.
# Ensure the compiler/linker can find libgcc in the TencentOS image.
toolchain_dir = os.environ.get(
    "SDPO_TOOLCHAIN_DIR",
    "/apdcephfs_gy4/share_303378103/user/audenhuang/stable_rl/recipe/sdpo/toolchain",
)
